...
public class TripHashBits {
    ...
    public int hash1(String input){
        ...
        //System.out.println("array is " + filter.size() + " returning: " + toRet);
        return toRet;
    }
    public int hash2(String input){
        ...
        toRet = toRet%size;
        if(toRet<0) toRet = -toRet;
        //System.out.println("hash2 returning " + toRet);
        return toRet;
    ...
    public int hash3(String input){
        ...
        toRet = toRet%size;
        if(toRet<0) toRet = -toRet;
        //System.out.println("hash3 returning " + toRet);
        return toRet;
    }
    public boolean inTrip(String input){
        int h1, h2, h3;
        h1 = hash1(input);
        h2 = hash2(input);
        h3 = hash3(input);
    ...
    public TripHashBits(String input) throws IOException{
            int h1, h2, h3;
            char tmpChar;
            int dictSize;
            String tmpWord = "";
